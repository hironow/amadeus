...
type MCPConfig struct { // nosemgrep: structure.multiple-exported-structs-go -- MCP config family (MCPConfig/MCPServerEntry) is a cohesive JSON schema pair; MCPConfig holds a map of MCPServerEntry [permanent]
