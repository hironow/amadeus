...
func (w *InsightWriter) Append(filename, kind, tool string, entry domain.InsightEntry) error { // nosemgrep: domain-primitives.multiple-string-params-go — filename/kind/tool are distinct routing fields [permanent]
