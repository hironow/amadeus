...
type BusSubscriber struct { // nosemgrep: structure.multiple-exported-structs-go -- session bus family (BusSubscriber/InProcessSessionBus) is a cohesive pub/sub implementation pair; BusSubscriber is the subscriber handle produced by InProcessSessionBus.Subscribe [permanent]
