...
type PolicyEngine struct { //nolint:govet // nosemgrep: naming.ambiguous-suffix-struct-go -- PolicyEngine is the established domain term for event-dispatch registry; renaming would obscure intent [permanent]
