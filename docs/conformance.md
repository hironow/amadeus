...
| **Output** | Divergence scores, PR convergence reports, corrective D-Mails (design-feedback / implementation-feedback) to downstream tools, insight ledger files (`insights/divergence.md`, `insights/convergence.md`) |
